...
const ContactButton = styled.input`
  ...
  background: linear-gradient(225deg, hsl(0, 100%, 25%) 0%, hsl(0, 50%, 35%) 100%);
  background: -moz-linear-gradient(225deg, hsl(0, 100%, 25%) 0%, hsl(0, 50%, 35%) 100%);
  background: -webkit-linear-gradient(225deg, hsl(0, 100%, 25%) 0%, hsl(0, 50%, 35%) 100%);
  padding: 13px 16px;
  margin-top: 2px;
  border-radius: 12px;
  border: none;
    ...
    <Container>
      <Wrapper>
        ...
        <ContactForm ref={form} onSubmit={handleSubmit}>
          <ContactTitle>Enviar Email 🚀</ContactTitle>
